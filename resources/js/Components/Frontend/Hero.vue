      ...
      y: 0,
        ...
        <div class="mr-auto place-self-center lg:col-span-7">
            ...
            <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">This
                free and open-source landing page template was built using the utility classes from <a href="https://tailwindcss.com" class="hover:underline">Tailwind CSS</a> and based on the
                components from the <a href="https://flowbite.com/docs/getting-started/introduction/" class="hover:underline">Flowbite Library</a> and the <a href="https://flowbite.com/blocks/" class="hover:underline">Blocks System</a>.</p>
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
            <img class="hidden w-full mb-4 rounded-lg lg:mb-0 lg:flex" src="http://127.0.0.1:8000/images/hero.png" alt="feature image 2">
        </div>
    </div>
</section>
</template>
