      ...
      y: 0,
            ...
            <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-2">
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <h2 class="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Contact Me
                    </h2>
                    <!-- List -->
                    <ul role="list" class="pt-8 space-y-5 border-t border-gray-200 my-7 dark:border-gray-700">
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">Veasna
                                PEN</span>
                        </li>
                        <li class="flex space-x-3">
                            <!-- Icon -->
                        ...
                        <li class="flex space-x-3">
                            ...
                            <span class="text-base font-medium leading-tight text-gray-900 dark:text-white">+885 15 326
                                731</span>
                        </li>
                ...
                <div class="text-gray-500 sm:text-lg dark:text-gray-400">
                    <form @submit.prevent="submit">
                        <div v-if="showMessage" class="m-2 p-4 bg-blue-500 text-white rounded-lg">
                            Thank you for contacting me.
                        </div>
                        <div id="alert-additional-content-1"
                        class="p-4 mb-4 border border-blue-300 rounded-lg bg-blue-50 dark:bg-blue-300" role="alert">
                        ...
                        <textarea v-model="form.body" id="message" rows="4"
                            class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="Leave a comment..."></textarea>
                            <InputError class="mt-2" :message="form.errors.body" />
                        <button type="submit"
                            class="mt-2 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Send</button>
                    </div>
                    </form>
                </div>
